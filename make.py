...
app = typer.Typer(
    ...
    help="""
    **Iris Project Command-Line Interface**
...
def feature_pipeline():
    ...
    requirements()
    _run_command(["uv", "run", "python", "iris_project/pipelines/feature_pipeline.py"])
...
def training_pipeline():
    ...
    requirements()
    _run_command(["uv", "run", "python", "iris_project/pipelines/training_pipeline.py"])
...
def inference_pipeline(
    ...
    _run_command(
        [
            ...
            "run",
            "python",
            "iris_project/pipelines/inference_pipeline.py",
            model_uri,
            input_path,
            output_path,
        ]
